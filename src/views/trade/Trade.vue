...
const { getUserAddress, getOrderInfo } = tradeStore;
const { addressList, orderInfo } = storeToRefs(tradeStore);
...
function changeDefault(address) {
...
async function submitOrder() {
  ...
  try {
    ...
    let result = await tradeStore.submitOrder(orderInfo.value.tradeNo, data);
    if (result == 200) {
      orderId.value = tradeStore.orderId;
...
<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="goods in orderInfo.detailArrayList" :key="goods.skuId">
          <li>
