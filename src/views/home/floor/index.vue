...
const props = defineProps(['floorData'])
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(keyword, index) in floorData.keywords" :key="index">{{ keyword }}</li>
              </ul>
            ...
            <div class="floorBanner">
              <div class="swiper-container" id="floor1Swiper" ref="floorSwiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide" v-for="slide in floorData.carouselList" :key="slide.id">
