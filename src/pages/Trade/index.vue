  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="userAddress.id"
        @click="changeAddress(userAddress, userAddressList)"
      >
        <span
          class="username"
      ...
      <ul>
        <li>
          <b
            ...
            >件商品，总商品金额</b
          >
          <span>¥{{ tradeData.totalAmount }}.00</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">
        应付金额:　<span>¥{{ tradeData.totalAmount }}.00</span>
      </div>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      userAddressList: (state) => state.trade.userAddress,
  ...
  methods: {
    changeAddress(userAddress, userAddressList) {
      // 用户点击更改收件信息的方法
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        paymentWay: "ONLINE",
        orderComment: this.textMsg,
        orderDetailList: this.tradeData.detailArrayList,
      };
